...
from ..utils.typing import Edge, Attr, Attributes
from ..utils.validation import obj_canonicalized_hash, unique_iter
...
class BaseGraph(abc.ABC):
    ...
    def plot(self, **kwargs):
        ...
        try:
            ...
            # If Graphviz rendering fails, try Viz.js rendering
            from ..utils.plotting import vizjs_render

            if "format" not in kwargs:
                kwargs["format"] = "svg"
            return vizjs_render(Gv, **kwargs)
    ...
    def to_graphviz(self, **kwargs):
        ...
        """
        from ..utils.plotting import to_graphviz
    ...
    def to_dot(self, **kwargs):
        ...
        """
        from ..utils.plotting import to_graphviz as _dot
